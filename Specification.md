...
```json
{"timestamp": "2025-03-18T14:00:00Z", "task": "Code Review", "description": "Reviewed pull requests and provided feedback."}
```

## User Interface (UI)

- A simple web page with:
  - A dropdown menu listing the last 20 tasks, based on the last 3 worklog files.
